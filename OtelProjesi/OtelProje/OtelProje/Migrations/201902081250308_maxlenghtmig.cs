namespace OtelProje.Migrations
{
    ...
    public partial class maxlenghtmig : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.OtelOzelliks", "OlusturanKisi", c => c.String(maxLength: 50));
            AlterColumn("dbo.OtelOzelliks", "GuncelleyenKisi", c => c.String(maxLength: 50));
        ...
        public override void Down()
        {
            ...
            AlterColumn("dbo.OtelOzelliks", "GuncelleyenKisi", c => c.String());
            AlterColumn("dbo.OtelOzelliks", "OlusturanKisi", c => c.String());
